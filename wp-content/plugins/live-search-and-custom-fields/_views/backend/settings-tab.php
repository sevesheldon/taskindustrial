...
$see_more = ( ! isset( $lscf_settings['see_more']['writing'] ) ? 'See More' : $lscf_settings['see_more']['writing'] );
...
<div class="lscf-settings">
	...
	<form name="lscf-settings" id="lscf-settings">
		...
		<div class="lscf-opt">
			...
			<input class="right" type="text" id="lscf-see-more-writing" value="<?php echo esc_attr( $see_more );?>"/>
