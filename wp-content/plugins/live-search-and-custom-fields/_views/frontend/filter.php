...
<div class="px-capf-wrapper row <?php echo esc_attr( $wrapper_class ); ?>" ng-app="px-capf">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 lscf-container <?php echo esc_attr( $container_class )?>" ng-controller="pxfilterController" >
		...
		<div class="row" id="lscf-posts-wrapper" ng-if="pluginSettings.existsPosts" ng-class="{'lscf-administrator' : pluginSettings.filterSettings.is_administrator == 1 }">
			...
			<div ng-if="pluginSettings.filterSettings.theme.sidebar.position == 'left' || pluginSettings.filterSettings.theme.sidebar.position == 'top' " class="{{ 'col-xs-12 ' +pluginSettings.className.sidebar+' px-filter-fields' }}" ng-include="pluginSettings.pluginPath + 'app/views/filterFields.html'"></div>
			...
			<div class="{{ 'col-xs-12 ' + pluginSettings.className.posts_theme + 'lscf-posts' }} ">
				...
				<div ng-switch="pluginSettings.filterSettings.theme.display">
					...
					<div ng-switch-when="accordion" class="view lscf-posts-accordion">
						<div viewmode-accordion></div>
					</div>

					<div ng-switch-when="portrait" class="view lscf-posts-portrait lscf-grid-view">
						<div viewmode-portrait></div>
					</div>

					<div ng-switch-when="custom-theme">
