...
if ( ! class_exists( 'WPB_Menu_Item_Custom_Fields' ) ) :
	/**
	* Menu Item Custom Fields Loader
	*/
	class WPB_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'WPB_Menu_Item_Custom_Fields_Walker';
	...
	add_action( 'wp_loaded', array( 'WPB_Menu_Item_Custom_Fields', 'load' ), 9 );
endif;
