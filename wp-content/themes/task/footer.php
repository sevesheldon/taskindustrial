...
extract(edgt_get_footer_variables());
...
if(isset($edgt_options['paspartu']) && $edgt_options['paspartu'] == 'yes'){?>
		...
		<?php if((isset($edgt_options['paspartu_on_bottom']) && $edgt_options['paspartu_on_bottom'] == 'yes') ||
...
<?php if(edgt_space_around_content() && !edgt_include_footer_in_content()){ ?>
...
<?php if(isset($edgt_toolbar)) include("toolbar.php") ?>
<?php wp_footer(); ?>
</body>
</html>