 ...
 * Class EdgeSkin
 */
class EdgeSkin extends EdgeSkinAbstract {
    /**
     * Skin constructor. Hooks to edgt_admin_scripts_init and edgt_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'edge';

        //hook to
        add_action('edgt_admin_scripts_init', array($this, 'registerStyles'));
        add_action('edgt_admin_scripts_init', array($this, 'registerScripts'));

        add_action('edgt_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('edgt_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('edgt_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('edgt_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            edgt_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            edgt_register_skin_style($styleHandle, $stylePath);
        }
	...
	public function setIcons() {
		$this->icons = array(
			...
			'masonry_gallery' => 'dashicons-schedule',
     ...
     *
     * @param EdgeAdminPage|string $activePage used for getting achors for current page
     * @param bool $showSaveBtn whether to show save button. Should be hidden on import page
     * @param bool $showSaveNotif whether to show save notifications. Not used on import page
     *
     * @see EdgeSkinAbstract::loadTemplatePart()
     */
    public function getHeader($activePage = '', $showSaveBtn = true, $showSaveNotif = true) {
        $this->loadTemplatePart('header', array(
            'active_page' => $activePage,
            'show_save_btn' => $showSaveBtn,
            'show_save_notif' => $showSaveNotif
        ));
    }
     ...
     * @param EdgeAdminPage $page current page to load
     *
     * @see EdgeSkinAbstract::loadTemplatePart()
     */
    ...
    public function renderImport() { ?>
        <div class="edgtf-options-page edgtf-page">
            <?php $this->getHeader(null, false ,false); ?>
            <div class="edgtf-page-content-wrapper">
                <div class="edgtf-page-content">
                    <div class="edgtf-page-navigation edgtf-tabs-wrapper vertical left clearfix">
