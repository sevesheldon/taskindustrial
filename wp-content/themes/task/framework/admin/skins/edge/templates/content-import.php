                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control edgtf-form-element dependence">
                                                    <option value="hudson">Hudson Original</option>
                                                    <option value="hudson1">1: Arch (Classic)</option>
                                                    <option value="hudson2">2: Marble (Left menu)</option>
                                                    <option value="hudson3">3: Store (Shop)</option>
                                                    <option value="hudson4">4: Tower (Slider effects)</option>
                                                    <option value="hudson5">5: Lobby (Left Menu Light)</option>
                                                    <option value="hudson6">6: Slate (Overlap)</option>
                                                    <option value="hudson7">7: Lamplight (Split Slider)</option>
                                                    <option value="hudson8">8: Exhibit (Tiles)</option>
                                                    <option value="hudson9">9: Billboard (Shop Wide)</option>
                                                    <option value="hudson10">10: Embed (Boxed)</option>
                                                    <option value="hudson11">11: Insider (Blog)</option>
                                                    <option value="hudson12">12: Studio (Portfolio)</option>
                                                    <option value="hudson13">13: Field (One Page)</option>
                                                    <option value="hudson14">14: Seafront (Boxed Light)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
            ...
            $(document).on('click', '#import_demo_data', function(e) {
                ...
                if (confirm('Are you sure, you want to import Demo Data now?')) {
                    ...
                    if(import_opt == 'content'){
                        for(var i=1;i<10;i++){
                            var str;
                            if (i < 10) str = 'hudson_content_0'+i+'.xml';
                            else str = 'hudson_content_'+i+'.xml';
                            jQuery.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {
