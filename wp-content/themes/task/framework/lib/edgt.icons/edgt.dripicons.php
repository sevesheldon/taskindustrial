 ...
 * Class EdgeDripicons
 */
class EdgeDripicons implements iIconCollection {
    /**
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = EDGE_ROOT . "/css/dripicons/dripicons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edgt_icon_dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
