...
include "edgt.simplelineicons.php";
include "edgt.dripicons.php";
include "edgt.icomoon.php";
...
class EdgeIconCollections {
    ...
    private function initIconCollections() {
        ...
        $this->addIconCollection('simple_line_icons', new EdgeSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new EdgeDripicons('Dripicons', 'dripicon'));
        $this->addIconCollection('icomoon', new EdgeIconsIcoMoon('Icomoon', 'icomoon_icon'));
    }
