...
class EdgeSimpleLineIcons implements iIconCollection {
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = EDGE_ROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edgt_icon_simple_line_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
