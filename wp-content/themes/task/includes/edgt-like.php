...
class EdgeLike {
	...
	function add_edgt_like_portfolio_post($portfolio_project_id){
		global $post;
		...
		return '<a class="'. $class .'" data-type="portfolio_post" id="edgt-like-'. $portfolio_project_id .'" title="'. $title .'">'.$output.'</a>';
	}
...
function edgt_like_portfolio_post($portfolio_project_id) {
	global $edgt_like;
	return $edgt_like->add_edgt_like_portfolio_post($portfolio_project_id);
}