...
if(!function_exists('edgt_transparent_header_class')) {
	...
	function edgt_transparent_header_class($classes) {
		...
		if(isset($edgt_options['header_bottom_appearance']) && $edgt_options['header_bottom_appearance'] !== 'regular' &&
            ((!in_array($edgt_options['header_background_transparency_sticky'], $transparent_values_array) && in_array($edgt_options['header_bottom_appearance'], $sticky_headers_array)) ||
                (!in_array($edgt_options['header_background_transparency_scroll'], $transparent_values_array) && in_array($edgt_options['header_bottom_appearance'], $fixed_headers_array)))) {
...
if(!function_exists('edgt_header_large_items_border_class')) {
    /**
     * Function that large items class to header tag
     * @param array array of classes from main filter
     * @return array of classes with added ajax header animation class
     */
    function edgt_header_large_items_border_class($classes) {
        global $edgt_options;

        if(isset($edgt_options['menu_item_style']) && $edgt_options['menu_item_style'] == 'large_item' && isset($edgt_options['menu_item_border_style']) && $edgt_options['menu_item_border_style'] == 'right_border'){
            $classes[]= 'large_items_menu_border';
        }

        return $classes;
    }

    add_filter('edgt_header_classes', 'edgt_header_large_items_border_class');
}