...
include 'edgt-instagram-helper.php';
...
class EdgeInstagramApi {
    ...
    const CODE_OPTION_NAME = 'edgt_instagram_code';
    const USER_ID_OPTION_NAME = 'edgt_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'edgt_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'edgt_instagram_code_redirect_uri';
