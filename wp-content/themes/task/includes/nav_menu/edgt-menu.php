...
if (!class_exists('edgt_type1_walker_nav_menu')) {
	...
	// add classes to ul sub-menus
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$wide_background = '';
			if(isset($edgt_options['enable_wide_manu_background']) && $edgt_options['enable_wide_manu_background'] == "yes" ){
			...
			if($item->hide == ""){
                ...
                if($depth == 0 && isset($edgt_options['enable_dropdown_menu_item_icon']) && $edgt_options['enable_dropdown_menu_item_icon'] == "yes" ){
				...
				$initial_icon_pack = $item->icon_pack;
				...
				if($args->has_children && $angle_icon_first_level != "") {
                    $item_output .= '<i class="edgt_menu_arrow fa '.$angle_icon_first_level.'"></i>';
                }
				$item_output .= '</span>'; //close span.item_inner
				if($item->description !== "") {
					$item_output .= '<span class="item_inner_description"> ' . $item->description . '</span>';
				}
                ...
                $item_output .= '<span class="animated_line"></span>';
