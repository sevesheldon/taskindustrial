...
if( ! class_exists( 'edgt_sidebar' ) ){
	...
	class edgt_sidebar{
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".__('Enter Name of the new Widget Area', 'edgt')."' name='edgt-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".__('Add Widget Area', 'edgt')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
