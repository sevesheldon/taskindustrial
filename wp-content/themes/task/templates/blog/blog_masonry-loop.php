...
$blog_img_size = 'full';
if(get_post_meta(get_the_ID(),'edgt_blog_list_masonry_article_size',true) !== ''){
	$blog_img_size = get_post_meta(get_the_ID(),'edgt_blog_list_masonry_article_size',true);
}

$blog_read_more_button_classes = '';
if (isset($edgt_options['blog_masonry_read_more_button_icon']) && $edgt_options['blog_masonry_read_more_button_icon'] == 'yes'){
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post_text">
				<div class="post_text_inner">
					...
					<?php
						edgt_excerpt();
						edgt_read_more_button('blog_masonry_read_more_button',$blog_read_more_button_classes);
					?>
				...
				<?php if ( has_post_thumbnail() ) { ?>
					<div class="post_image">
						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
							<?php the_post_thumbnail($blog_img_size); ?>
						</a>
					</div>
				<?php } ?>
