...
if($background_pattern != "") {
    ...
    $circle_wrapper_style .= "background-image: url('". esc_url($background_image_src) . "');";
    $circle_wrapper_style .= "background-position: center center;";
}
...
$html .= '<div class="edgt_circle_wrapper">';
$html .= '<div class="edgt_circle_inner'. $border_class.' " style="'.$circle_wrapper_style.'"><div class="edgt_circle_inner2 '.$image_with_text_class.'" style="'.$circle_style.' '.$image_with_text_style.'">';
...
$html .= '</div></div>';
$html .= '<span class="edgt_circle_arrow arrow_right"></span>';
$html .= "</div>";
