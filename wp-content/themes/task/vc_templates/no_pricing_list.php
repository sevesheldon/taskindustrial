...
$html .= '<div class="edgt_pricing_list" '.$background_style.'>';
	if($title !=''){
		$html .='<div class="edgt_pricing_list_title"><span>'.$title.'</span></div>'; // close div.edgt_pricing_list_title
	}	
	$html .='<ul class="edgt_pricing_list_holder '.$type.'">';
		$html .= do_shortcode($content);
	$html .='</ul>'; // close ul.edgt_pricing_list_holder
$html .= '</div>'; // close div.edgt_pricing_list
