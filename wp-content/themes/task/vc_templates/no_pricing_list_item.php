...
if( $enable_new_item == 'enable_new_item' ) {
    ...
    $new_item_html .= '<span '.$new_item_text_style.'>' . __('NEW', 'edgt') . '</span>';
    $new_item_html .= '<i class="edgt_icon_font_awesome fa fa-certificate" '.$new_item_icon_style.'></i> ';
    $new_item_html .= '</div>';
}
...
$html .= '<li class="edgt_pricing_list_item" '.$separator_styles.'>';
$html .= '<div class="edgt_pricing_item_text" style="'.$background_styles.'">';
$html .= '<'.$title_tag.' class="edgt_pricing_item_title" style="'.$title_styles.'">'.$title.'</'.$title_tag.'>';
$html .= '</div>'; //close div.edgt_pricing_item_text
$html .= '<div class="edgt_pricing_item_price"  style="'.$background_styles.'">';
$html .= '<span style="'.$price_styles.'">'.$price.'</span>';
$html .= '</div>'; // close div.edgt_pricing_item_price
$html .= '</li>'; // close li.edgt_pricing_list_item

$html .= '<li class="edgt_pricing_item_includes_text" '.$separator_bottom_styles.'><p style="'.$text_styles.'">'.$text.'</p></li>';
