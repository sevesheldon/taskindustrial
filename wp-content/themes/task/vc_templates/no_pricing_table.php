...
if($type=="price_on_top" ){
    $html .= "<li class='prices' " . edgt_get_inline_style($price_background_style) . ">";
    $html .= "<div class='price_in_table' " .  edgt_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".edgt_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".edgt_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";

    $html .= "</div>"; // close div.price_in_table
    $html .= "</li>"; //close li.prices
    $html .= "<li class='cell table_title ".$title_clasess."' ".edgt_get_inline_style($title_holder_style)."><span class='title_content' ".$title_style.">".$title."</span>";
...
if($type=="title_on_top"){	
    $html .= "<li class='cell table_title ".$title_clasess."' ".edgt_get_inline_style($title_holder_style).">";
    $html .= "<span class='title_content' ".$title_top_type_title_style.">".$title."</span>";
    $html .= "</li>";    

    $html .= "<li class='prices $pricing_content_clasess' $price_background_style>";
    $html .= "<div class='price_in_table' " .  edgt_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".edgt_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".edgt_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";
...
if($show_button == "yes"){
	if($pricing_button_type == "standard_button"){
		if(isset($button_text) && $button_text !== '') {
			$html .="<li class='price_button $button_class' ".edgt_get_inline_style($button_holder_style)." ".$data_attr_button." >";
			if($type=="title_on_top"){
		...
		$html .="<a class='button_on_bottom' ".edgt_get_inline_style($button_on_bottom_styles)." href='$link' target='$target'></a>";
		$html .="</li>";//close li.price_button
	}
}
