...
if($title_letter_spacing != ""){
    $title_letter_spacing = (strstr($title_letter_spacing, 'px', true)) ? $title_letter_spacing : $title_letter_spacing . "px";
    $separator_box_styles[] = "letter-spacing:". $title_letter_spacing;
}

if($title_font_family != ""){
    $separator_box_styles[] = "font-family:".str_replace('+', ' ', $title_font_family).', sans-serif';
}

if($title_font_style != ""){
    $separator_box_styles[] = "font-style:". $title_font_style;
}

if($title_font_weight != ""){
    $separator_box_styles[] = "font-weight:". $title_font_weight;
}

if($title_text_transform != ""){
    $separator_box_styles[] = "text-transform:". $title_text_transform;
}
...
$output .= '<span '.edgt_get_inline_attr($line_width,"data-line-width").' class="'.esc_attr($css_class.' '.$animation_class.' '.$text_position).'">';
    $output .= '<span class="separator_wrapper" style="'.implode(';', $separator_wrapper_styles).'">';
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '<span class="edgt_line_before '.$separator_line_classes.'"  style="'.implode(';', $separator_lines_styles).';'.$line_right_margin.'">';
    }
    if($line_dots == "yes") {
    ...
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '</span>'; // end edgt_line_before
    }
    ...
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '<span class="edgt_line_after '.$separator_line_classes.'"  style="'.implode(';', $separator_lines_styles).';'.$line_left_margin.'">';
    }
    if($line_dots == "yes") {
    ...
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '</span>'; // end edgt_line_after
    }
