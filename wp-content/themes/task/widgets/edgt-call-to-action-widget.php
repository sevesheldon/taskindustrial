...
class Edge_Call_To_Action extends WP_Widget {
    public function __construct() {
		parent::__construct(
	 		'edgt_call_to_action_widget', // Base ID
			'Edge Call To Action', // Name
			array( 'description' => __( 'Edge Call to Action Widget', 'edgt' ), ) // Args
		);
	}
...
function edgt_call_to_action_widget_load(){
	register_widget('Edge_Call_To_Action');
}
add_action('widgets_init', 'edgt_call_to_action_widget_load');
