...
class Edge_Instagram_Widget extends WP_Widget {
    private $params;
    ...
    public function widget($args, $instance) {
        ...
        if(is_array($images_array) && count($images_array)) { ?>
            <ul class="edgt_instagram_feed clearfix col_<?php echo esc_attr($number_of_cols); ?>">
            <?php
            foreach ($images_array as $image) { ?>
                <li>
                    <a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
                        <?php echo edgt_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
                    </a>
                </li>
            <?php } ?>
            </ul>
...
function edgt_instagram_widget_load(){
    register_widget('Edge_Instagram_Widget');
}
